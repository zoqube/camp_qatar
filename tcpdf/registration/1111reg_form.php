...
$htmlcontent2 = '<table style="text-align:right;"> <p ><b>بيانات الطالب:</b></p>
             <p ><b>(ملاحظة: يرجى ملء استمارة تسجيل خاصة لكل طالب)</b></p>            
             <p ><span style="color:red" >'.$_POST["fname"].' </span> <b>الاسم الأول:</b></p>
             <p ><span style="color:red" >'.$_POST["fname"].' </span> <b>اسم العائلة:</b> </p>
             ...
             <p ><span style="color:red" >'.$_POST["p1workphone"].' </span>الوالد/ ولي الأمر (1) هاتف العمل (اختياري):</p>
...
$attachment = $pdf->Output('/home1/varunvic/public_html/demos/qatarcamp/tcpdf/registration/campqatar-registration.pdf', 'F');
...
$email->Body      = "hiiiiiiiii";
$email->AddAddress( 'saleelva@gmail.com' );

$email->AddAttachment( '/home1/varunvic/public_html/demos/qatarcamp/tcpdf/registration/campqatar-registration.pdf' );
